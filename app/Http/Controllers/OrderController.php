...
class OrderController extends Controller
{
    ...
    public function createOrder(Zone $zone, Request $request) {
        ...
        // $order = [ 'firstname' => $inputs['firstname'], 'lastname' => $inputs['lastname'], 'addressOne' => $inputs['addressOne'], 'addressTwo' => $inputs['addressTwo'], 'order_sku' => $randomNumber, 'zone_per_pound' => $zone->perPound, 'zone_cost' => 500,   'name' => auth()->user()->firstname . ' ' . auth()->user()->lastname, 'address' => $zone->address, 'parish' => $zone->parish, 
