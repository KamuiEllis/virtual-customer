...
<body>
    <div class='row first-banner text-center pt-2'>
        ...
        <form class='row' style='width:100%; margin-bottom:0px;' action="/logout" method="POST" >
            
              <div class='col-6'>
                <p style='padding:0; float:left;'>Welcome to Computers Online International Store</p>
            </div>
