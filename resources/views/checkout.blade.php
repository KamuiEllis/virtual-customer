      ...
      @csrf
        ...
        <div class='col-9'>
            ...
            <div class="form-group mt-3">
                ...
                <input type="date" class="form-control" name='CardExpiration' id="exampleInputPassword1" placeholder="Enter card's expiry date">
            </div>

            <div class="form-group mt-3">
                <label for="exampleInputPassword1">CVV</label>
                <input type="text" class="form-control" name='CardCvv' id="exampleInputPassword1" placeholder="Enter card's CVV">
            </div>
